...
function Login() {
  ...
  // 🚀🚀when the user is logout the the status value will be changed
  ...
  return (
    <Container>
      <div>
        <div className="bg-gray-900 rounded-lg p-8 text-gray-100 max-w-md mx-auto  ">
          <p className="text-xl font-bolwwad text-center mb-6">Login</p>
          ...
          <div className="flex justify-center mt-4">
            <button
              ...
              className="p-2 rounded-md bg-transparent mr-2"
            >
              <svg
